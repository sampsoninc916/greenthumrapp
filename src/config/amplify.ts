...
export const API_ENDPOINTS = {
  ...
  UPLOADS_CREATE: import.meta.env.VITE_API_UPLOADS_CREATE,
  UPLOADS_CLEANUP: import.meta.env.VITE_API_UPLOADS_CLEANUP,
  ...
  EMAIL_SUBSCRIBE: import.meta.env.VITE_API_EMAIL_SUBSCRIBE,
  EMAIL_UNSUBSCRIBE: import.meta.env.VITE_API_EMAIL_UNSUBSCRIBE,
  EMAIL_LIFECYCLE: import.meta.env.VITE_API_EMAIL_LIFECYCLE,
  EMAIL_TEMPLATES_SYNC: import.meta.env.VITE_API_EMAIL_TEMPLATES_SYNC,
  EMAIL_CONSENT: import.meta.env.VITE_API_EMAIL_CONSENT,
};
...
const API_ENV_KEY_MAP: Record<(typeof REQUIRED_API_ENDPOINT_KEYS)[number], string> = {
  ...
  UPLOADS_CREATE: 'VITE_API_UPLOADS_CREATE',
  UPLOADS_CLEANUP: 'VITE_API_UPLOADS_CLEANUP',
